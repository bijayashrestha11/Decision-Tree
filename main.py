...
#Social Media Add Purchase
def social_preprocess():  
  #get the dataset
  col_names = ['User ID', 'Gender', 'Age', 'EstimatedSalary', 'Purchased']
  data = pd.read_csv("datasets/Social_Network_Ads.csv", skiprows=1, header=None, names=col_names)
...
#Covid-19 Symptoms and Presence 
def covid_preprocess():
  #get the dataset
  data = pd.read_csv("datasets/covid_dataset.csv")
  print(data.head(10))
